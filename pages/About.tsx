        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="prose prose-lg mx-auto text-gray-600">
              <motion.div 
                ...
                className="mb-12 whitespace-pre-line leading-relaxed"
              >
                  {content.story}
              </motion.div>
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="glass-panel bg-brand-red/5 p-8 rounded-2xl border border-brand-red/10 mb-12 shadow-sm"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <motion.div 
                    whileHover={{ y: -5 }}
                    className="glass-panel bg-white p-8 rounded-xl shadow-sm border border-gray-100 transition-all"
                  >
