        ...
        <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 w-full pt-20">
              <motion.div 
                  ...
                  className="max-w-4xl"
              >
                  <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-panel border border-white/20 text-white font-bold text-xs uppercase tracking-widest mb-8 shadow-lg backdrop-blur-md">
                  ...
                  <motion.p variants={itemVariants} className="text-lg md:text-xl text-white/90 font-medium leading-relaxed max-w-xl mb-12 border-l-4 border-brand-red pl-6 drop-shadow-md">
                      {content.heroSubtitle}
                  </motion.p>
                  
                  <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-5">
                      <Link to="/inventory" className="group relative px-8 py-4 bg-brand-red text-white font-bold rounded-2xl overflow-hidden shadow-xl shadow-red-900/40 transform transition-transform active:scale-95">
                      ...
                      <Link to="/showroom" className="group px-8 py-4 glass-panel border border-white/20 text-slate-900 font-bold rounded-2xl hover:bg-white transition-colors shadow-lg active:scale-95">
                          Visit Showroom
                      </Link>
                  </motion.div>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {[
                      ...
                      <motion.div 
                          ...
                          whileHover={{ y: -10 }}
                          className="glass-dark p-10 rounded-3xl border border-white/5 hover:border-brand-red/30 transition-colors group cursor-default"
                      >
                          <div className="w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center mb-8 text-brand-red text-2xl group-hover:scale-110 group-hover:bg-brand-red group-hover:text-white transition-all duration-300 shadow-lg">
          ...
          <div className="absolute bottom-0 left-0 p-8 md:p-16 max-w-md">
              ...
              >
                  <div className="flex items-start gap-4">
                      <div className="bg-brand-dark p-4 rounded-full text-white shrink-0 shadow-lg">
                      ...
                      <div>
                          ...
                          <Link to="/showroom" className="px-6 py-2 bg-brand-red text-white text-sm font-bold rounded-lg inline-flex items-center gap-2 hover:bg-red-700 transition-colors shadow-md">
