  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-brand-dark py-24 text-center text-white">
        ...
        <p className="text-xl text-gray-300 max-w-2xl mx-auto">{content.description}</p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
                <img src="https://images.unsplash.com/photo-1562141989-c5c79ac8f576?auto=format&fit=crop&w=600&q=80" alt="Showroom Interior" className="rounded-lg shadow-lg hover:scale-[1.02] transition-transform duration-500" />
                <img src="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=600&q=80" alt="Cars lined up" className="rounded-lg shadow-lg mt-8 hover:scale-[1.02] transition-transform duration-500" />
            </div>
        </div>
