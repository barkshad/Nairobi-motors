      ...
      <div className="bg-slate-50 min-h-screen pt-28 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
              ...
              >
                  <div className="glass-panel sticky top-28 p-6 rounded-2xl shadow-sm bg-white/70 backdrop-blur-xl">
                      ...
                      <div className="mb-6">
                          ...
                          <div className="relative group">
                              <input 
                                  ...
                                  className="w-full bg-white/50 border border-gray-200 rounded-xl py-3 px-4 pl-10 focus:ring-2 focus:ring-brand-red focus:border-transparent outline-none transition-all shadow-sm group-hover:shadow-md backdrop-blur-sm"
                                  value={searchTerm}
                      ...
                      <div className="mb-6">
                          ...
                          <select 
                              className="w-full bg-white/50 border border-gray-200 rounded-xl py-3 px-3 outline-none focus:ring-2 focus:ring-brand-red transition-all shadow-sm cursor-pointer backdrop-blur-sm"
                              value={selectedMake}
                          ...
                          <AnimatePresence mode="popLayout">
                              {filteredCars.length > 0 ? (
                                  ...
                                  <motion.div 
                                      initial={{ opacity: 0 }}
                                      animate={{ opacity: 1 }}
                                      className="col-span-full py-20 text-center glass-panel rounded-2xl"
                                  >
